...
4. When setting up your Spotify app in the Developer Dashboard, add your redirect URI (e.g., `http://127.0.0.1:8000/NickelPlayer-1920x1080/` or `http://127.0.0.1:8000/NickelPlayer-1200x1600/`) to the list of allowed redirect URIs.
